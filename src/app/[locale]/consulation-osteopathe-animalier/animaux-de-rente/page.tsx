...
export async function generateMetadata({
  ...
  return {
    title: `${d.consultations.rente.numero} | ${d.consultations.hero.titre}`,
    description: d.consultations.rente.chapo,
    alternates: {
...
export default async function RentePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      <NavEspeces locale={locale} libelles={c.sommaire} courant="rente" />
